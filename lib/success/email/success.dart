             ...
             Expanded(
                child: FadeInLeftBig(
                  child: Column(children: [
                    ...
                    FadeInRightBig(child: const Text("Your email address has been successfully been verified.")),
                  ]),
                ),
              ),
            ],
    ...
    return Padding(
      ...
      child: Column(
            ...
            children: <Widget>[
              ...
              FadeInRightBig(
                child: const Text("Your email address has been successfully been verified.",
